...
CREATE TABLE IF NOT EXISTS channel_log   (user_id INTEGER PRIMARY KEY, json TEXT);
CREATE TABLE IF NOT EXISTS notif_state    (user_id INTEGER PRIMARY KEY, json TEXT);
"""
