...
(function () {
  ...
  const AULA_API = {
    ...
    gameGenerate: (subject, topic) => req('POST', '/api/game/generate', { subject, topic, mode: 'game' }),
    labComplete: (subject, score, topic) => req('POST', '/api/lab/complete', { subject, score, topic: topic || '' }),
